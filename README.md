...
The Arduino sketch and the Python script allows a wireless communication between Dorji DRF1276DM et LoRa32u4 II, where :
- LoRa32u4 II sends the message "Hello Dorji" every 10 seconds to Dorji DRF1276DM
- Once Dorji DRF1276DM receives the message "Hello Dorji", it sends automatically the message "Hello LoRa, thanks for asking" to LoRa32u4 II
- 
